...
namespace RoxRender
{
	...
	class IRoxCompiledShadersProvider
	{
	public:
	...
	// Potential security risks allowing Shader Provider Injection
	//void setCompiledShadersProvider(IRoxCompiledShadersProvider* provider);
}
